...
class TestTfeatures(unittest.TestCase):
    ...
    def test_astfeatures_class_normal(self):
        ...
        operators['AugAssign'] = numba.int32(1)
        operators['Add'] = numba.int32(1)
        keywords = Dict.empty(key_type=types.unicode_type,
                              value_type=types.int32)
        keywords['FunctionDef'] = numba.int32(1)
        keywords['Return'] = numba.int32(1)
        keywords['If'] = numba.int32(1)
        literals = Dict.empty(key_type=types.unicode_type,
                              value_type=types.int32)
        literals['Constant'] = numba.int32(3)
        ...
        self.assertEqual(features1.cunodes, numba.int32(13))
