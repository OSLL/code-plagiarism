...
class TestCreateReport:
    ...
    def test_content_same_between_calls(self, report_type: ReportType):
    ...
    def test_content_different_between_calls(self, report_type: ReportType):
        first_report_path = REPORTS_FOLDER / "report1.html"
        second_report_path = REPORTS_FOLDER / "report2.html"
