...
CSV_REPORT_COLUMNS: Final[Tuple[str, ...]] = (
    'date', 'first_modify_date', 'second_modify_date',
    'first_path', 'second_path', 'first_heads',
    'second_heads', 'jakkar', 'operators', 'keywords',
    'literals', 'weighted_average', 'struct_similarity',
    'compliance_matrix'
)
